...
namespace ServiceLabBD.Controllers
{
    public class MechanicsController : Controller
    {
        ...
        public MechanicsController(ServiceContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,Experience")] Mechanic mechanic)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,Experience")] Mechanic mechanic)
        {
            if (id != mechanic.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ServiceContext.Mechanics'  is null.");
            }
            var mechanic = await _context.Mechanics.FindAsync(id);
            if (mechanic != null)
            {
